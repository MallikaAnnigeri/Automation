...
public static void main(String[] args) {
	...
	List<WebElement> price = driver.findElements(By.xpath("//td[2]"));

	for (int i = 0; i < products.size(); i++) {
		WebElement productText = products.get(i);
		String pn = productText.getText();
		WebElement productprice = price.get(i);
